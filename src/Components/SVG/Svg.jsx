...
const Svg = ({style}) => {
  return (
     <div >
          <svg style={{style}} version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 134 26" enableBackground="new 0 0 134 26" color="#03314B" className="m:h-6 h-5 " width={'100'} height={'20'}>
