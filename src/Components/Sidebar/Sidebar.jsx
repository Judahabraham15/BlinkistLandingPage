...
const Sidebar = () => {
    function hideSidebar(){
        const sidebar =document.querySelector('.sidebar').classList.remove('open');
    ...
    <div className='sidebar'>
      <div className="sides">
        ...
        <path fill="currentColor" d="M134,18.4v4.2c-0.8,0.2-1.8,0.3-2.9,0.3c-4,0-6.4-1.9-6.4-5.9v-4.8 h-2.2V8.1h2.2V4.6h5v3.5h3.9v4.2h-3.9v4.3c0,1.4,0.7,1.9,2.5,1.9C132.6,18.4,133.2,18.4,134,18.4z"></path>
         ...
         <a href="#" ><svg xmlns="http://www.w3.org/2000/svg"onClick={hideSidebar} className='side-svg' height="16px" viewBox="0 -960 960 960" width="16px" fill="white"><path d="m256-200-56-56 224-224-224-224 56-56 224 224 224-224 56 56-224 224 224 224-56 56-224-224-224 224Z"/></svg></a>
      </div>
    
           <ul className='side'>
          
          <li><a href="#"><span className='b'>For Buisness</span></a></li>
          <li><a href="#"><span>For individuals</span></a></li>
